namespace MultiSupplierMTPlugin.Localized
{
    ...
    class LocalizedKeyCommon : LocalizedKeyBase
    {
        ...
        [LocalizedValue("fc5a8237-ff33-48ac-b121-1534859b719f", "Supports memoQ and DeepL formats. DeepL format default columns and order: \r\nSourceTerm, TargetTerm, SourceLanguage, TargetLanguage", "支持 memoQ 导出格式和 deepL 格式，deepL 格式的默认列名和顺序为：\r\nSourceTerm, TargetTerm, SourceLanguage, TargetLanguage")]
